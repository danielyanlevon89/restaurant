...
@section('container')
    ...
    <a href="{{route('admin.menu.add')}}" type="button" class="btn btn-success"
       style="width:170px;height:35px;padding-top:9px;">+ Add
        Menu</a>
    ...
    @foreach($products as $product)
        ...
        @if($i%3==1)
            <div class="card-deck" style="margin-top:20px;">
                ...
                <div class="card">
                    <img class="card-img-top" src="{{ asset('assets/images/'.$product->image) }}"
                    ...
                    <div class="card-body">
                        ...
                        @if($product->meal_type==0)
                            <p style="text-transform:capitalize;">Meal Type : Breakfast</p>
                        @endif
                        @if($product->meal_type==1)
                            <p style="text-transform:capitalize;">Meal Type : Lunch</p>
                        @endif
                        @if($product->meal_type==2)
                    ...
                    <div class="card-footer">
                        <small class="text-muted"><a href="{{route('admin.menu.edit', ['id' => $product->id])}}"
                                                     class="btn btn-primary">Edit</a>
                            <a href="{{route('admin.menu.delete', ['id' => $product->id])}}" class="btn btn-danger"
