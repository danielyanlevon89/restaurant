        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('admin.customize.save')}}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="30" name="description" class="form-control" id="exampleInputName1"
                                      rows="5">{{  $custo->description  }}</textarea>
